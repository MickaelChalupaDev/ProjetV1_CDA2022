...
public class ServletPageEnchereNonCommencee extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		article=aMgr.lireArticle(Integer.valueOf(request.getParameter("noArticle")));
		articleInit=aMgr.lireArticle(Integer.valueOf(request.getParameter("noArticleInit")));
