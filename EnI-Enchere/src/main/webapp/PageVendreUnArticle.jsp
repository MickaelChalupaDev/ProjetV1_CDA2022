...
<td>
<table class="table0">
    <form method="post" action="ServletPageVendreUnArticle" enctype="multipart/form-data">
        ...
        <tr>
            ...
            <td><label> Début de l'enchère : </label><input style="width:210px" class="input0" type="date" name="dateDebutEncheres" value = "<%=date%>" required/></td>
        </tr>
        <tr>
        		
            <td><label> Fin de l'enchère : </label>
            <input style="margin-left: 25px;width:210px" class="input0" type="date" name="dateFinEncheres" value="<%=date%>" required/>
        ...
        <legend>Retrait</legend>
           ...
           <label> Rue : </label><input style="margin-left: 90px;width:210px"  class="input0" type="text" name="rue" value = "${sessionScope.utilisateur.getRue()}"  required/> <br/>
           <label> Code postal : </label><input style="margin-left: 40px;width:210px" class="input0" type="text" name="codePostal" value = "${sessionScope.utilisateur.getCodePostal()}"  required/>  <br/>
           <label> Ville : </label><input style="margin-left: 85px;width:210px" class="input0" type="text" name="ville" value = "${sessionScope.utilisateur.getVille()}"  required/>  <br/>
        </fieldset>
