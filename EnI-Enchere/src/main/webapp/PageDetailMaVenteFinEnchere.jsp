...
<header>
  <h1> ENI-Enchères</h1>
  <h2 Style="text-align: center"> ${requestScope.userGagnant.getPseudo()} a remporté l'enchere </h2>
</header>
...
<div style="margin-left: 500px;margin-top: 80px;width:210px" >
  <a href="${pageContext.request.contextPath}/PageListeEncheresConnecte.jsp"> <input class="input3" type="button" value="Retrait effectué"/>  </a>
</div>
</body>
</html>